...
<!-- <script src="/app/statics/localjs/appinfomodify.js"></script> -->
...
function  loadCategoryLevel(pid,cl,categoryLevel){
	$.ajax({
		type:"GET",//请求类型
		url:"/app/appInfo/categorylevellist",//请求的url
		data:{pid:pid},//请求参数
...
function delfile(id){
	$.ajax({
		type:"GET",//请求类型
		url:"/app/appInfo/delfile",//请求的url
...
$(function(){  
	...
	$.ajax({
		type:"GET",//请求类型
		url:"/app/appInfo/getFlatFormList",//请求的url
